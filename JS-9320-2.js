...
function getUniqueHomeWorld() {
  ...
  const homeworldLwrCase = homeworldRaw.map((homeworld) =>homeworld.toLocaleLowerCase());
  const nonRepeatHomeWorld= [...new Set(homeworldLwrCase)];
  return nonRepeatHomeWorld
}


function renderFilters(){
  homeWoldList=getUniqueHomeWorld()
  const row =document.createElement("div")
  row.classList.add("row")
  row.classList.add("filter-row")
  container.append(row)
  homeWoldList.push("all")
  homeWoldList.forEach(element => {
    ...
    label.innerText=element.toLocaleLowerCase()
    ...
    input.addEventListener('click',()=>{
        ...
        if (element === "other"){
            filteredCharacters=characters.filter(character => character.homeworld === undefined)
        }else if (element ==="all"){
             filteredCharacters=characters
        } else{
            filteredCharacters=characters.filter(character =>character.homeworld?.toLocaleLowerCase()=== element)
        }
